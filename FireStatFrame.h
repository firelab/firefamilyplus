...
class CFireStatFrame : public CMDIChildWnd
{
	DECLARE_DYNCREATE(CFireStatFrame)
protected:
	CFireStatFrame();           // protected constructor used by dynamic creation
