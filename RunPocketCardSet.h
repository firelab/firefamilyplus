// RunPocketCardSet.h : Declaration of the CPocketCardSet

#pragma once


class CRunPocketCardSet : public CRecordset
{
public:
	CRunPocketCardSet(CDatabase* pDatabase = NULL);
	DECLARE_DYNAMIC(CRunPocketCardSet)
