// ReportsSet.h : Implementation of the CReportsSet class

 

// CReportsSet implementation

// code generated on Wednesday, September 28, 2005, 2:10 PM

#include "stdafx.h"
#include "ReportsSet.h"
IMPLEMENT_DYNAMIC(CReportsSet, CRecordset)
...
CString CReportsSet::GetDefaultConnect()
{
...
CString CReportsSet::GetDefaultSQL()
{
	return _T("[ffpReports]");
}
...
// ODBC will try to automatically convert the column value to the requested type
	...
	RFX_Text(pFX, _T("[reportName]"), m_reportName);

}
/////////////////////////////////////////////////////////////////////////////
// CReportsSet diagnostics

#ifdef _DEBUG
void CReportsSet::AssertValid() const
{
	CRecordset::AssertValid();
}

void CReportsSet::Dump(CDumpContext& dc) const
{
	CRecordset::Dump(dc);
}
#endif //_DEBUG
