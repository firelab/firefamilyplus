// FireEditSet.h : Implementation of the CFireEditSet class
 


// CFireEditSet implementation

// code generated on Wednesday, September 28, 2005, 1:57 PM

#include "stdafx.h"
#include "FireEditSet.h"
IMPLEMENT_DYNAMIC(CFireEditSet, CRecordset)

CFireEditSet::CFireEditSet(CDatabase* pdb)
	: CRecordset(pdb)
{
	m_FireID = 0;
	m_Year = L"";
...
CString CFireEditSet::GetDefaultConnect()
{
...
CString CFireEditSet::GetDefaultSQL()
{
	return _T("[Fire]");
}

void CFireEditSet::DoFieldExchange(CFieldExchange* pFX)
{
...
/////////////////////////////////////////////////////////////////////////////
// CFireEditSet diagnostics

#ifdef _DEBUG
void CFireEditSet::AssertValid() const
{
	CRecordset::AssertValid();
}

void CFireEditSet::Dump(CDumpContext& dc) const
{
	CRecordset::Dump(dc);
}
#endif //_DEBUG
