// FireOptionsSet.h : Implementation of the CFireOptionsSet class

 

// CFireOptionsSet implementation

// code generated on Wednesday, September 28, 2005, 1:58 PM

#include "stdafx.h"
#include "FireOptionsSet.h"
IMPLEMENT_DYNAMIC(CFireOptionsSet, CRecordset)

CFireOptionsSet::CFireOptionsSet(CDatabase* pdb)
	: CRecordset(pdb)
{
	m_SIG_Station = L"";
	m_Lightning = FALSE;
...
CString CFireOptionsSet::GetDefaultConnect()
{
...
CString CFireOptionsSet::GetDefaultSQL()
{
	return _T("[ffpFireOptions]");
}

void CFireOptionsSet::DoFieldExchange(CFieldExchange* pFX)
{
...
// ODBC will try to automatically convert the column value to the requested type
	...
	RFX_Bool(pFX, _T("[Conditional]"), m_Conditional);

}
/////////////////////////////////////////////////////////////////////////////
// CFireOptionsSet diagnostics

#ifdef _DEBUG
void CFireOptionsSet::AssertValid() const
{
	CRecordset::AssertValid();
}

void CFireOptionsSet::Dump(CDumpContext& dc) const
{
	CRecordset::Dump(dc);
}
#endif //_DEBUG
