// FFPHourlyEventsSet.cpp : Implementation of the CFFPHourlyEventsSet class


 
// CFFPHourlyEventsSet implementation

#include "stdafx.h"
#include "FFPHourlyEventsSet.h"
IMPLEMENT_DYNAMIC(CFFPHourlyEventsSet, CRecordset)

CFFPHourlyEventsSet::CFFPHourlyEventsSet(CDatabase* pdb)
	: CRecordset(pdb)
{
	m_SIG_Station = "";
	m_Row = 0;
...
CString CFFPHourlyEventsSet::GetDefaultConnect()
{
...
CString CFFPHourlyEventsSet::GetDefaultSQL()
{
	return _T("[ffpHourlyEvents]");
}

void CFFPHourlyEventsSet::DoFieldExchange(CFieldExchange* pFX)
{
...
/////////////////////////////////////////////////////////////////////////////
// CFFPHourlyEventsSet diagnostics

#ifdef _DEBUG
void CFFPHourlyEventsSet::AssertValid() const
{
	CRecordset::AssertValid();
}

void CFFPHourlyEventsSet::Dump(CDumpContext& dc) const
{
	CRecordset::Dump(dc);
}
#endif //_DEBUG
