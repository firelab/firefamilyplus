// DOIUnitSet.h : Implementation of the CDOIUnitSet class

 

// CDOIUnitSet implementation

// code generated on Wednesday, September 28, 2005, 2:05 PM

#include "stdafx.h"
#include "DOIUnitSet.h"
IMPLEMENT_DYNAMIC(CDOIUnitSet, CRecordset)

CDOIUnitSet::CDOIUnitSet(CDatabase* pdb)
	: CRecordset(pdb)
{
	m_WFMIcode = L"";
	m_AgencyID = 0;
...
CString CDOIUnitSet::GetDefaultConnect()
{
...
CString CDOIUnitSet::GetDefaultSQL()
{
	return _T("[refDOIUnits]");
}

void CDOIUnitSet::DoFieldExchange(CFieldExchange* pFX)
{
...
// ODBC will try to automatically convert the column value to the requested type
	...
	RFX_Text(pFX, _T("[WFMIcode]"), m_WFMIcode);

}
/////////////////////////////////////////////////////////////////////////////
// CDOIUnitSet diagnostics

#ifdef _DEBUG
void CDOIUnitSet::AssertValid() const
{
	CRecordset::AssertValid();
}

void CDOIUnitSet::Dump(CDumpContext& dc) const
{
	CRecordset::Dump(dc);
}
#endif //_DEBUG
